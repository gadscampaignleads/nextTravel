                                ...
                                <div className="boking_header" >
                                    <div className="booking_main">
                                        <div className='booking_title'>
                                            ...
                                            <span>(Please provide the Following details  to complete your booking)</span></div>
                                    ...
                                    <div className="booking_main booking_main1">
                                        <div className='booking_title'>
                                            <div className="book_semi1">
                                                ...
                                                Contact Information </div>  <span>(Enter your email and phone number and we will send you a booking)</span></div>
                                        <div className="mt-4 booking_main_m">
                                            <div className="row form_booking_f">
                                                <div className="col-6">
                                                    <div className="form_booking">
